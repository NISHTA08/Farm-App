const en = {
  ...
  farm: {
    ...
    planted: "Planted",
    harvest: "Harvest",
    setDates: "Set planting & harvest dates",
    estValueAtHarvest: "Est. value at harvest",
    atCurrentPrice: "at current price",
    loadPrices: "Load prices",
    loadPricesToSeeValue: "Load prices to see estimated value",
    priceNotAvailable: "Price not available for this crop",
    estValueByCrop: "Est. value by crop",
    total: "Total",
    yieldKg: "Yield (kg)",
