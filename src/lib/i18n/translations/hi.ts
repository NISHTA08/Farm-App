...
const hi: TranslationKeys = {
  ...
  farm: {
    ...
    seasonProgress: "मौसम प्रगति",
    planted: "बुवाई",
    harvest: "कटाई",
    setDates: "बुवाई और कटाई की तारीख सेट करें",
    estValueAtHarvest: "कटाई पर अनुमानित मूल्य",
    atCurrentPrice: "वर्तमान भाव पर",
    loadPrices: "भाव लोड करें",
    loadPricesToSeeValue: "अनुमानित मूल्य देखने के लिए भाव लोड करें",
    priceNotAvailable: "इस फसल की कीमत उपलब्ध नहीं",
    estValueByCrop: "फसल अनुसार अनुमानित मूल्य",
    total: "कुल",
    yieldKg: "उपज (किग्रा)",
    expectedYieldKg: "अपेक्षित उपज (किग्रा)",
    expectedYield: "अपेक्षित उपज",
    unitKg: "किग्रा",
    unitQuintals: "क्विंटल",
    unitPlants: "पौधे",
    estHarvestValue: "अनुमानित कटाई मूल्य",
  },
  chat: {
    title: "AI कृषि सहायक",
